...
// row exists yet; pressing ✓ inserts the row immediately (decision #5) and
// fills `setId`. weightKg / reps are null until the lifter touches the
// controls (blank rows start empty — last session is never pre-filled,
// decision #7).
